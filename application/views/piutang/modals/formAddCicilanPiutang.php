                  ...
                  <div class="tab-pane fade show active" id="custom-tabs-three-home" role="tabpanel" aria-labelledby="custom-tabs-three-home-tab">
                    <form onsubmit="handleAddCicilan(event)" id="formAddCicilan">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" readonly required class="form-control" id="debtorNameDetail">
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="number" required class="form-control" id="totalReceivableDetail">
                      </div>
                      <button type="submit" id="button-add-cicilan" class="btn btn-primary btn-block">Simpan Cicilan</button>
                    </form>
                  </div>
